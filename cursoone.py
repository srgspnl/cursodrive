...
# URL do arquivo GeoJSON no Google Drive (modificado para download direto)
geojson_url = "https://drive.google.com/uc?id=1XZkhBHt_jL84sci35TyLdhsHFOueP4p4&export=download"
...
try:
    ...
    # Salvar o conteúdo do arquivo em memória
    geojson_content = BytesIO(response.content)

    # Carregar o arquivo GeoJSON com o GeoPandas
    gdf = gpd.read_file(geojson_content, driver='GeoJSON')
